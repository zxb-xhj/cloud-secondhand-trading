...
public class AuditController {
     ...
     */
    @PutMapping()
    public R update(@RequestBody List<AuditSaveReq> req, HttpServletRequest request) {
//        Enumeration<String> attributeNames = request.getAttributeNames();
//        while (attributeNames.hasMoreElements()){
//            System.out.println("request "+request.getAttribute(attributeNames.nextElement()));
//        }
