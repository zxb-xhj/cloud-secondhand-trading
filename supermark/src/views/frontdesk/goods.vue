    ...
    <div class="nav">
      <div class="product-nav">
        ...
        <el-tabs v-model="activeName" type="card">
          ...
          <el-tab-pane v-for="category in categorys" :key="category.id" :name="category.id+''" :label="category.name"></el-tab-pane>
        </el-tabs>
      </div>
    </div>
    <div style="height: 2rem;"></div>
    <!-- 分类标签END -->
    <div style="background-color: #F5F5F5"  v-loading="listLoading">
      <!-- 主要内容区 -->
