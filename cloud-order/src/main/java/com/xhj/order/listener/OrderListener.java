...
//            HttpServletRequest addrVoRequest = orderAddrVo.getRequest();
//            Enumeration<String> attributeNames = addrVoRequest.getAttributeNames();
//            if (attributeNames!=null){
//                while (attributeNames.hasMoreElements()){
//                    String nextElement = attributeNames.nextElement();
//
////                    request.setAttribute(nextElement,addrVoRequest.getAttribute(nextElement));
//                }
//            }
