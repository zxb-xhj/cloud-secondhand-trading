...
public class PayServiceImpl extends ServiceImpl<PayMapper, Pay> implements PayService {
    ...
    public PageUtils<PayVo> getPayPageList(OrderListPageReq req) {
        ...
        wrapper.like(req.getBuyer()!=null,Pay::getBuyerName,req.getBuyer())
                .like(req.getSeller()!=null,Pay::getSellerName,req.getSeller())
                .like(req.getName()!=null,Pay::getGoodsName,req.getName())
                .like(req.getState()!=null,Pay::getPayStatus,req.getState());
