  ...
  <div class="index" id="index">
    ...
    <div class="main">
          ...
          <div class="block" style="width: 80%;">
            ...
            <el-carousel trigger="click" height="28.2rem">
              <el-carousel-item v-for="(item, index) in imageArr" :key="index">
                <img class="small" :src="item.imageUrl" @click="showGoods(item.targetUrl)" style="width: 100%; height: 28.2rem;border-radius: 10px;" />
              </el-carousel-item>
            </el-carousel>
          </div>
    </div>
    ...
    getSchool(){
      if(sessionStorage.getItem("school")==null){
        this.$http.post("/api/cloud-member/school/list"
            ...
            sessionStorage.setItem("school",res.data);
          });
      }
    },
    // getTime(){
