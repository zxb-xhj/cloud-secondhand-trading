...
export const WeEditable = Vue.extend({
    name: 'WeEditable',
    props: {
        option: {
            type: Object,
    ...
    created() {
        ...
        const globalCallback = {
            customAlert: (info, type) => {
                var _a, _b;
                (_b = (_a = this.option.config).customAlert) === null || _b === void 0 ? void 0 : _b.call(_a, info, type);
            },
            onCreated: (editor) => {
                var _a, _b;
                (_b = (_a = this.option.config).onCreated) === null || _b === void 0 ? void 0 : _b.call(_a, editor);
            },
            onDestroyed: (editor) => {
                var _a, _b;
                (_b = (_a = this.option.config).onDestroyed) === null || _b === void 0 ? void 0 : _b.call(_a, editor);
            },
            onMaxLength: (editor) => {
                var _a, _b;
                (_b = (_a = this.option.config).onMaxLength) === null || _b === void 0 ? void 0 : _b.call(_a, editor);
            },
            onFocus: (editor) => {
                var _a, _b;
                (_b = (_a = this.option.config).onFocus) === null || _b === void 0 ? void 0 : _b.call(_a, editor);
            },
            onBlur: (editor) => {
                var _a, _b;
                (_b = (_a = this.option.config).onBlur) === null || _b === void 0 ? void 0 : _b.call(_a, editor);
            },
            onChange: (editor) => {
        ...
        const initialize = () => {
            ...
            const temp = {
                ...
                config: Object.assign(Object.assign({}, config), globalCallback),
            };
            let content = '';
            let htmltemp = '';
            if (extendCache) {
            ...
            try {
                ...
                if (jsono.length) {
                    instance = createEditor(Object.assign(Object.assign({}, temp), { content: jsono }));
                }
            }
            catch (e) {
            }
                ...
                if (!instance)
                    instance = createEditor(Object.assign(Object.assign({}, temp), { html: htmltemp }));
            }
            if (!instance.isEmpty()) {
                executeUpdate(instance);
            }
        ...
        // 监听 v-bind:json 变化
        this.$watch('json', () => {
            if (!this.modelJson || this.json === cache.json)
                return;
            if (!instance) {
        ...
        this.$watch('html', () => {
            // 以 v-bind:json 为主
            if (this.modelJson || !this.modelHtml || this.html === cache.html)
                return;
            if (!instance) {
        ...
        this.$watch('option.config.placeholder', (nv) => {
            var _a;
            const target = (_a = this.$refs.elem) === null || _a === void 0 ? void 0 : _a.querySelector('.w-e-text-placeholder');
            if (target instanceof HTMLElement)
                target.innerHTML = nv !== null && nv !== void 0 ? nv : '';
        });
        this.$watch('option.config.scroll', (nv) => {
            var _a;
            const target = (_a = this.$refs.elem) === null || _a === void 0 ? void 0 : _a.querySelector('.w-e-scroll');
            if (target instanceof HTMLElement)
...
WeEditable.install = function (vue) {
