...
export declare class ToggleModeButtonMenu implements Omit<IButtonMenu, 'exec'> {
    readonly standrad: Standrad;
    readonly tag = "button";
    ...
    readonly type: ToggleTarget;
    constructor(standrad: Standrad);
    getValue(): boolean;
    isActive(): boolean;
    isDisabled(): boolean;
