...
declare type CssRule = Record<string, string | number>;
export declare type WeCssRuleMap = Record<string, CssRule>;
export declare type WeCssRuleList = string | (string | WeCssRuleMap)[] | WeCssRuleMap;
/**
 * 编辑器内容缓存
 */
...
export declare type WeEditableReload = () => IDomEditor | undefined;
...
export declare type WeToolbarReload = (editable: IDomEditor) => Toolbar | undefined;
